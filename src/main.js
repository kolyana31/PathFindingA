...
document.getElementById("ClearWalls").addEventListener("click", () => {
	if (document.SearchPause) {
		...
		resetAfterSearch();
		document.getElementById("ClearWalls").innerText = document.SearchPause
			? "Cancel Search"
			: "Clear Field";
	} else {
		resetAfterSearch();
	...
	document.getElementById(
		"SearchResults"
	).innerHTML = `<i style="color: lightgreen;">Start Search to get results</i>`;
});
